 ...
 * @author gabri
 */
public class JanelaCadastroEditora extends javax.swing.JFrame {

    /**
     * Creates new form JanelaCadasroAlunos
     */
    public JanelaCadastroEditora() {
        initComponents();
    ...
    private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
        ...
        String cidadeOrigem = jTextFieldCidade.getText();
        int id = Integer.parseInt(jTextFieldID.getText());
        
        Editora editoraNova = new Editora(id, nome, cidadeOrigem);
        EditoraDAO dao = new EditoraDAO();
        dao.create(editoraNova);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaCadastroEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame janelaCadastroAlunos = new JanelaCadastroEditora();
